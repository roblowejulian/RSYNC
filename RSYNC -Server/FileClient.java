...
try {
InetAddress addr=InetAddress.getByName("fe80::20c:29ff:fe92:60ca");
...
DataOutputStream dos = new DataOutputStream(os);//creating an output stream to send the file to the client
dos.writeUTF(myFile.getName());
dos.writeLong(mybytearray.length);
dos.write(mybytearray, 0, mybytearray.length);//writing the contents of the file to the client
dos.flush();
